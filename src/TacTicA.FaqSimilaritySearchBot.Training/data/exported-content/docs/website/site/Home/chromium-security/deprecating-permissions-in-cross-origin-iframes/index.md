URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\Home\chromium-security\deprecating-permissions-in-cross-origin-iframes\index.md
---
breadcrumbs:
- - /Home
  - Chromium
