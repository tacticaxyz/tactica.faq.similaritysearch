URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\chromium-os\ec-development\getting-started-building-ec-images-quickly\index.md
---
breadcrumbs:
- - /chromium-os
  - Chromium OS
