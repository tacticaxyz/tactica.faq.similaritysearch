URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\chromium-os\chromiumos-design-docs\filesystem-autoupdate-supplements\index.md
---
breadcrumbs:
- - /chromium-os
  - Chromium OS
