URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\chromium-os\chromiumos-design-docs\hardening-against-malicious-stateful-data\index.md
---
breadcrumbs:
- - /chromium-os
  - Chromium OS
