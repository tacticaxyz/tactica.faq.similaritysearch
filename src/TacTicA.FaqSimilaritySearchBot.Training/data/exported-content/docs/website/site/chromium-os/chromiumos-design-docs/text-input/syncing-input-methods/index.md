URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\chromium-os\chromiumos-design-docs\text-input\syncing-input-methods\index.md
---
breadcrumbs:
- - /chromium-os
  - Chromium OS
