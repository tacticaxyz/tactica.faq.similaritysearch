URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\chromium-os\developer-library\guides\device\chrome-os-mainline-kernel-on-kevin-chromebook-plus\index.md
---
breadcrumbs:
