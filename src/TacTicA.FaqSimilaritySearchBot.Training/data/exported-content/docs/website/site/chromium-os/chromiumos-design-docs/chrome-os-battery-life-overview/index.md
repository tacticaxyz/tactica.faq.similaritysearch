URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\chromium-os\chromiumos-design-docs\chrome-os-battery-life-overview\index.md
---
breadcrumbs:
- - /chromium-os
  - Chromium OS
