URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\chromium-os\developer-library\guides\kernel\using-an-upstream-kernel-on-snow\index.md
---
breadcrumbs:
