URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\developers\how-tos\trace-event-profiling-tool\memory\startup-tracing-with-memory-profiling\index.md
---
breadcrumbs:
- - /developers
  - For Developers
