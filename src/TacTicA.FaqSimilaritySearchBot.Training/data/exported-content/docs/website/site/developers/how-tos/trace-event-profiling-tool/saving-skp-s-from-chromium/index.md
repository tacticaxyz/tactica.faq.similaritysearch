URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\developers\how-tos\trace-event-profiling-tool\saving-skp-s-from-chromium\index.md
---
breadcrumbs:
- - /developers
  - For Developers
