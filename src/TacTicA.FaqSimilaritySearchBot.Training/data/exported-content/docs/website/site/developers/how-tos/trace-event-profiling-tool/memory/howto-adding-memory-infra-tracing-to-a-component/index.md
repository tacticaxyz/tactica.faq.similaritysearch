URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\developers\how-tos\trace-event-profiling-tool\memory\howto-adding-memory-infra-tracing-to-a-component\index.md
---
breadcrumbs:
- - /developers
  - For Developers
