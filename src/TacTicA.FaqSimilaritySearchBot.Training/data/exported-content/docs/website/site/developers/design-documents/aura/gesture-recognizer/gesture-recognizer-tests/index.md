URL:https://source.chromium.org/chromium/chromium/src/+/main:docs\website\site\developers\design-documents\aura\gesture-recognizer\gesture-recognizer-tests\index.md
---
breadcrumbs:
- - /developers
  - For Developers
