URL:https://source.chromium.org/chromium/chromium/src/+/main:third_party\tflite\src\tensorflow\lite\g3doc\api_docs\python\tflite_support\metadata_writers\image_classifier\MetadataWriter.md
page_type: reference
description: Writes metadata into an image classifier.
...
<meta itemprop="name" content="tflite_support.metadata_writers.image_classifier.MetadataWriter" />
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/metadata/python/metadata_writers/image_classifier.py#L33-L138">
...
<code>tflite_support.metadata_writers.image_classifier.MetadataWriter(
...
<a target="_blank" class="external" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/metadata/python/metadata_writers/image_classifier.py#L84-L138">View source</a>
...
<a target="_blank" class="external" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/metadata/python/metadata_writers/image_classifier.py#L36-L82">View source</a>
...
<td>
input image tensor informaton, if not specified, default input
