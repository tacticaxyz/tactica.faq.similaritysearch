URL:https://source.chromium.org/chromium/chromium/src/+/main:third_party\tflite\src\tensorflow\lite\g3doc\api_docs\python\tflite_support\task\processor\ClassificationResult.md
page_type: reference
description: Contains one set of results per classifier head.
...
<meta itemprop="name" content="tflite_support.task.processor.ClassificationResult" />
...
<code>tflite_support.task.processor.ClassificationResult(
...
<tr>
<td>
`classifications`<a id="classifications"></a>
</td>
<td>
A list of `Classifications` objects.
</td>
</tr>
</table>
